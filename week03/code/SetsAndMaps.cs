    ...
    public static string[] FindPairs(string[] words)
{
    ...
    {
        if (word[0] == word[1]) continue; // Skip palindromes like "aa"
    ...
    public static bool IsAnagram(string word1, string word2)
{
    ...
    // Quick check: if lengths don't match, not anagrams
    if (normalized1.Length != normalized2.Length)
    {
        return false;
    }

    // Count characters for word1
    ...
    // Count characters for word2 and compare with word1
    ...
    public static string[] EarthquakeDailySummary()
{
    ...
    foreach (var feature in featureCollection.Features)
    {
        ...
        {
            summaryList.Add($"{place} - Mag {magnitude.Value}");
        }
    }
